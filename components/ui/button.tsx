    ...
    variants: {
      variant: {
        ...
        destructive:
          ...
          outline:
          "border border-neutral-200 bg-transparent shadow-sm hover:bg-neutral-200 hover:text-neutral-900 dark:border-neutral-800 dark:bg-transparent dark:hover:bg-neutral-800 dark:hover:text-neutral-50",
        secondary:
          "bg-neutral-100 text-neutral-900 shadow-sm hover:bg-neutral-100/80 dark:bg-neutral-800 dark:text-neutral-50 dark:hover:bg-neutral-800/80",
        ghost: "bg-transparent text-neutral-900 dark:text-neutral-50",
